...
Event OnLoad()
  Self.GetLinkedRef(None).SetValue(Test_PiercingHealth, 100.0)
  Self.GetLinkedRef(None).SetValue(Test_FireHealth, 100.0)
  Self.GetLinkedRef(None).SetValue(Test_CryoHealth, 100.0)

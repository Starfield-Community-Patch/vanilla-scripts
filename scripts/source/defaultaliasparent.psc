...
Function CheckAndSetStageAndCallDoSpecificThing(DefaultScriptFunctions:ParentScriptFunctionParams ParentScriptFunctionParams)
	...
	DefaultScriptFunctions.Trace(self, "CheckAndSetStageAndCallDoSpecificThing() RefToCheck=" + RefToCheck + " LocationToCheck=" + LocationToCheck, ShowTraces)
	...
	if LocationToCheck == None ;this isn't entirely unexpected
		...
		LocationToCheck = TryToGetCurrentLocation()
	endif

	Quest QuestToSetOrCheck = GetOwningQuest()
	ObjectReference CheckAliveActorOrShip = GetReference()
...
Function DoSpecificThing(DefaultScriptFunctions:ParentScriptFunctionParams ParentScriptFunctionParams, ObjectReference RefToDoThingWith = None, bool LastRefToDoThingWith = true)
	...
	DefaultScriptFunctions.Trace(self, "DoSpecificThing() on DefaultAliasParent - empty function - doing nothing.", ShowTraces)
EndFunction

...
Event OnShipLanding(Bool abComplete)
  If abComplete
    spaceshipreference myShip = Self.GetRef() as spaceshipreference
    If myShip != None
      BEEncounterTypeSurface.SendStoryEventAndWait(None, None, Self.GetRef(), (CrewSizePercent * 100.0) as Int, 0)
    EndIf
  EndIf
EndEvent

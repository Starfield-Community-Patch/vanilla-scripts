...
Auto State Waiting
	Event OnLoad()
		GoToState("Done")
		SQ_Parent.SetupDamagedShip(Self, ShouldBeDestroyed, ShouldBeDerelict, ShouldApplyDerelictName, ShouldDamageRandomSystems, ShouldDisableExteriorLights, ShouldBlockRepairOfDestroyedParts, AdditionalActorValuesToDamage)
	EndEvent
EndState

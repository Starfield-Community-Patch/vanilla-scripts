...
Event OnDestroyed(ObjectReference akDestroyer)
		DefaultScriptFunctions.Trace(self, "OnDestroyed() akDestroyer: " + akDestroyer, ShowTraces)

		DefaultScriptFunctions:ParentScriptFunctionParams ParentScriptFunctionParams = DefaultScriptFunctions.BuildParentScriptFunctionParams(RefToCheck = akDestroyer, LocationToCheck = TryToGetCurrentLocation())
		DefaultScriptFunctions.Trace(self, "OnDestroyed() calling CheckAndSetStageAndCallDoSpecificThing() ParentScriptFunctionParams: " + ParentScriptFunctionParams, ShowTraces)

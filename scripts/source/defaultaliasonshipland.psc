...
Event OnShipLanding(bool abComplete)
	if SQ_PlayerShip && abComplete == false
		SQ_PlayerShip.ClearLandingZone(GetShipRef())
	endif
	if SetStageWhenLandingComplete == abComplete
		DefaultScriptFunctions.Trace(self, "OnShipLanding() abComplete: " + abComplete, ShowTraces)
		...
		DefaultScriptFunctions.Trace(self, "OnShipLanding() calling CheckAndSetStageAndCallDoSpecificThing() ParentScriptFunctionParams: " + ParentScriptFunctionParams, ShowTraces)

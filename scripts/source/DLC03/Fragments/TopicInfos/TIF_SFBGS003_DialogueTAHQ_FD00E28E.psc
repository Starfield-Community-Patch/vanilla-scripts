...
Scriptname DLC03:Fragments:TopicInfos:TIF_SFBGS003_DialogueTAHQ_FD00E28E Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyQuest.AstraExchange(SFBGS003_Astras_MedAmount.GetValueInt())
;END CODE
EndFunction
;END FRAGMENT

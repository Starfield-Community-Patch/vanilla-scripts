...
Scriptname DLC03:Fragments:TopicInfos:TIF_SFBGS003_DialogueTAHQ_FD00E2B9 Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyQuest.AstraExchange(SFBGS003_Astras_SmallAmount.GetValueInt())
;END CODE
EndFunction
;END FRAGMENT

...
Scriptname Fragments:Quests:QF_SE_Player_FAB16_00052514 Extends Quest Hidden Const
...
;BEGIN CODE
; If you refuse the hail, the Spacer attacks
(Alias_HailingShip.GetRef() as SpaceshipReference).RemoveFromFaction(PPlayerFriendFaction)
(Alias_HailingShip.GetRef() as SpaceshipReference).StartCombat(Alias_PlayerShip.GetRef() as SpaceshipReference)
;END CODE
EndFunction
;END FRAGMENT

...
Scriptname Fragments:Quests:QF_SE_ZW14_0005EAF0 Extends Quest Hidden Const
...
;BEGIN CODE
;Moving this to script on alias
;kmyQuest.StartMoveTimer()
;END CODE
EndFunction
;END FRAGMENT
...
SE_ZW14_DoneOnceGlobal.SetValue(1)
;END CODE
EndFunction
;END FRAGMENT

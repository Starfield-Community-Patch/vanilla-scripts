...
Scriptname Fragments:Quests:QF_City_NA_FAB_Quest14_000EC267 Extends Quest Hidden Const

;BEGIN FRAGMENT Fragment_Stage_0001_Item_00
Function Fragment_Stage_0001_Item_00()
;BEGIN CODE
Alias_Actor01.GetRef().Enable()
Alias_WaitingCustomer.GetRef().Enable()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_WaitingCustomer.GetRef().Disable()

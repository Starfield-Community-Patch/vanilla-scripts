...
Scriptname Fragments:Quests:QF_FC_Neon_CT_CityLife_Encou_000F8A94 Extends Quest Hidden Const

;BEGIN FRAGMENT Fragment_Stage_0001_Item_00
Function Fragment_Stage_0001_Item_00()
;BEGIN CODE
Alias_E05EnableMarker.GetRef().Enable()
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
; Remove the actors
Alias_E05EnableMarker.GetRef().Disable()
Stop()
;END CODE
EndFunction
;END FRAGMENT

...
Scriptname Fragments:Quests:QF_CREW_EliteCrew_SimeonBank_001DF911 Extends Quest Hidden Const

;BEGIN FRAGMENT Fragment_Stage_0000_Item_00
Function Fragment_Stage_0000_Item_00()
;BEGIN CODE
;SetStage on this quest to make Simeon recruitable and already hired
SetStage(1)
SetStage(50)

;Move Simeon to the player, make him the active follower, and remind him about his AI package
(Simeon.GetActorRef() as EliteCrewDebugScript).DebugMakeActiveEliteCrew()
Simeon.GetActorRef().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT

...
Scriptname Fragments:Quests:QF_CRWGideonAker_00014E55 Extends Quest Hidden Const

;BEGIN FRAGMENT Fragment_Stage_0000_Item_00
Function Fragment_Stage_0000_Item_00()
;BEGIN CODE
;SetStage on this quest to make Gideon recruitable and already hired
SetStage(1)
SetStage(50)

;Move Gideon to the player, make him the active follower, and remind him about his AI package
(Gideon.GetActorRef() as EliteCrewDebugScript).DebugMakeActiveEliteCrew()
Gideon.GetActorRef().MoveTo(Game.GetPlayer())
Gideon.GetActorRef().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT

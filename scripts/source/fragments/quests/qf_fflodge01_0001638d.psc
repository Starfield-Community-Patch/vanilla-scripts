...
Scriptname Fragments:Quests:QF_FFLodge01_0001638D Extends Quest Hidden Const
...
Alias_Heller.GetActorRef().moveto(Alias_HellerWoundedMArker.GetRef())
...
;Barrett is now a temp follower
(SQ_Followers as SQ_FollowersScript).SetRoleActive(Alias_Barrett.GetActorRef())
;END CODE
EndFunction
;END FRAGMENT
...
;Barrett is no longer a temp follower
(SQ_Followers as SQ_FollowersScript).SetRoleInActive(BarrettREF)

...
Scriptname Fragments:Quests:QF_MQ401e_00173104 Extends Quest Hidden Const
...
;NPC has the Artifacts and is kill-able
...
;BEGIN CODE
If GetStageDone(210) && GetStageDone(220) && GetStageDone(230) && GetStageDone(240) && GetStageDone(250) && GetStageDone(260) && GetStageDone(270) && GetStageDone(290)
  SetStage(1000)
EndIf
;END CODE
EndFunction
...
;BEGIN CODE
If GetStageDone(210) && GetStageDone(220) && GetStageDone(230) && GetStageDone(240) && GetStageDone(250) && GetStageDone(260) && GetStageDone(270) && GetStageDone(280)
  SetStage(1000)
EndIf
;END CODE
EndFunction
...
;BEGIN CODE
Game.GetPlayer().RemoveItem(Credits, MQ401E_ArtifactPrice.GetValueInt())
SetStage(300)
;END CODE
EndFunction
;END FRAGMENT

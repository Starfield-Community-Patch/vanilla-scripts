...
Scriptname Fragments:Quests:QF_CREW_EliteCrew_RosieTanne_001D65C0 Extends Quest Hidden Const

;BEGIN FRAGMENT Fragment_Stage_0000_Item_00
Function Fragment_Stage_0000_Item_00()
;BEGIN CODE
;SetStage on this quest to make Rosie recruitable and already hired
SetStage(1)
SetStage(50)

;Move Rosie to the player, make her the active follower, and remind her about her AI package
(Rosie.GetActorRef() as EliteCrewDebugScript).DebugMakeActiveEliteCrew()
Rosie.GetActorRef().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT

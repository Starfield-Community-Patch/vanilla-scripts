...
Scriptname Fragments:Quests:QF_DialogueCydoniaConvo_Comm_000812F2 Extends Quest Hidden Const

;BEGIN FRAGMENT Fragment_Stage_0010_Item_00
Function Fragment_Stage_0010_Item_00()
;BEGIN CODE
CY_Community_Book01_Variation.Mod(1)
;END CODE
EndFunction
;END FRAGMENT
...
;again.
If CY_Community_Book01_Variation.GetValue() == 3
	CY_Community_Book01_Variation.SetValue(0)
EndIf
;END CODE
EndFunction
;END FRAGMENT

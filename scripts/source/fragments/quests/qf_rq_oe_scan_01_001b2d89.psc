...
Scriptname Fragments:Quests:QF_RQ_OE_Scan_01_001B2D89 Extends Quest Hidden Const

;BEGIN FRAGMENT Fragment_Stage_0000_Item_00
Function Fragment_Stage_0000_Item_00()
;BEGIN AUTOCAST TYPE rq_scancreaturesscript
Quest __temp = self as Quest
rq_scancreaturesscript kmyQuest = __temp as rq_scancreaturesscript
;END AUTOCAST
;BEGIN CODE
; handled by quest script
;END CODE
EndFunction
;END FRAGMENT
...
SetObjectiveDisplayed(150) ; Optional
...
; lower credits reward
float reward = RQ_OE_Scan_01_CreditsReward.GetValue()*0.75
RQ_OE_Scan_01_CreditsReward.SetValueInt(reward as int)
;END CODE
EndFunction
;END FRAGMENT
...
If !GetStageDone(150) ; Didn't scan a dead creature

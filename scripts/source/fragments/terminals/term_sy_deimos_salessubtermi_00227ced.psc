...
Scriptname Fragments:Terminals:TERM_SY_Deimos_SalesSubTermi_00227CED Extends TerminalMenu Hidden Const
...
;BEGIN CODE
City_CY_RedTape01_Education.SetValue(1)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
City_CY_RedTape01_Education.SetValue(2)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
City_CY_RedTape01_Education.SetValue(3)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
City_CY_RedTape01_Education.SetValue(4)
;END CODE
EndFunction
;END FRAGMENT

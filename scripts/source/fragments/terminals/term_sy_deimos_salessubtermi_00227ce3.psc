...
Scriptname Fragments:Terminals:TERM_SY_Deimos_SalesSubTermi_00227CE3 Extends TerminalMenu Hidden Const
...
;BEGIN CODE
City_CY_RedTape01Application02.SetValue(1)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
City_CY_RedTape01Application02.SetValue(2)
;END CODE
EndFunction
;END FRAGMENT

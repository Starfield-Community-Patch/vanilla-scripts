...
Scriptname Fragments:Terminals:TERM_MQ207C_Nishina02_II_Freq Extends TerminalMenu Hidden Const

;BEGIN FRAGMENT Fragment_TerminalMenu_02
Function Fragment_TerminalMenu_02(ObjectReference akTerminalRef)
;BEGIN CODE
;Try to start calibration for this universe (and fail).
...
;BEGIN CODE
;Try to start calibration for this universe (and succeed).
MQ207C.TryToStartFrequencyCalibration(akTerminalRef.GetValue(MQ207C_MasterControlTerminalUniverseValue) as int)
;END CODE
EndFunction
;END FRAGMENT

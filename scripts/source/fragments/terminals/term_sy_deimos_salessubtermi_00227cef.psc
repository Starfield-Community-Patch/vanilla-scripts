...
Scriptname Fragments:Terminals:TERM_SY_Deimos_SalesSubTermi_00227CEF Extends TerminalMenu Hidden Const
...
;BEGIN CODE
City_CY_RedTape01_Experience.SetValue(1)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
City_CY_RedTape01_Experience.SetValue(2)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
City_CY_RedTape01_Experience.SetValue(3)
;END CODE
EndFunction
;END FRAGMENT

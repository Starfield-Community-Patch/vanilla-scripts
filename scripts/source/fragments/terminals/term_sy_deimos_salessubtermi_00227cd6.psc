...
Scriptname Fragments:Terminals:TERM_SY_Deimos_SalesSubTermi_00227CD6 Extends TerminalMenu Hidden Const

;BEGIN FRAGMENT Fragment_TerminalMenu_01
Function Fragment_TerminalMenu_01(ObjectReference akTerminalRef)
;BEGIN CODE
City_CY_RedTape01Application05.SetValue(2)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
City_CY_RedTape01Application05.SetValue(1)
;END CODE
EndFunction
;END FRAGMENT
